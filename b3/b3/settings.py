...
CSRF_COOKIE_SAMESITE = "None" if os.getenv("ENV") == "DEV" else "Lax"
SESSION_COOKIE_SECURE = True
SESSION_COOKIE_SAMESITE = "None" if os.getenv("ENV") == "DEV" else "Lax"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "b3"),
        "USER": os.getenv("DB_USER", "postgres"),
        "PASSWORD": os.getenv("DB_PASSWORD"),
        "HOST": os.getenv("DB_HOST", "postgres-b3"),
...
# 2FA
OTP_TOTP_ISSUER = f"b3 {os.getenv('ENV')}"
...
if DEBUG:
    ...
    # Disable 2FA
    INSTALLED_APPS.remove("b3.apps.OTPAdminConfig")
